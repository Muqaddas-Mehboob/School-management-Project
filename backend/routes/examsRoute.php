...
$c=new ExamController($database);
$s=parseRouteSegments('exams'); $id=$s[0]??null; $m=$_SERVER['REQUEST_METHOD'];
if($m==='GET'){ jsonResponse($id==='upcoming'?$c->upcoming():($id?$c->show($id):$c->index($_GET))); }
