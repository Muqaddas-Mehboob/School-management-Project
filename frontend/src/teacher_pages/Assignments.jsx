...
const mockAssignments = [
  {
    ...
    submissions: 18,
    totalStudents: 25,
    description: 'Write a 5-page essay analyzing the causes and effects of the American Revolution. Include at least 3 primary sources.',
    status: 'active'
  },
  {
    id: '2',
    ...
    submissions: 22,
    totalStudents: 25,
    description: 'Complete problems 1-20 from Chapter 5. Show all work for full credit.',
    status: 'active'
  },
  {
    id: '3',
    ...
    submissions: 25,
    totalStudents: 25,
    description: 'Submit a detailed lab report on the photosynthesis experiment conducted last week.',
    status: 'active'
  },
  {
    id: '4',
    ...
    submissions: 0,
    totalStudents: 25,
    description: 'Complete the online quiz covering chapters 1-5 of "To Kill a Mockingbird".',
    status: 'upcoming'
  },
  {
    id: '5',
...
export default function App() {
  ...
  return (
    <DashboardLayout pageTitle="Assignments"><div className="flex h-screen bg-gray-50">
      {/* Sidebar */}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-white border-b p-2 sm:p-3 md:p-4 lg:p-6" style={{ borderColor: '#e5e7eb' }}>
          <div className="flex items-center justify-between mb-2 sm:mb-3 md:mb-4">
            <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
              ...
              <div>
                <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl" style={{ color: '#0e2038' }}>Assignments</h1>
                <p className="text-[9px] xs:text-xs sm:text-sm text-gray-500 mt-0.5 sm:mt-1">Manage and track student assignments</p>
              </div>
            </div>
            <button
            ...
            <div className="flex overflow-x-auto">
              {[
                ...
                <button
                  ...
                  className="px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 whitespace-nowrap transition-colors text-[10px] xs:text-xs sm:text-sm"
                  style={{
        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
          {/* Assignment List */}
          <div 
            className={`w-full lg:w-96 xl:w-1/3 bg-white border-r flex flex-col ${
          ...
          >
            {selectedAssignment ? (
              ...
              <div className="h-full flex items-center justify-center text-gray-400 px-4 text-center">
                <div>
                  <p className="text-xs sm:text-sm mb-2">Select an assignment to view details</p>
                  <p className="text-[10px] xs:text-xs sm:text-sm">or create a new one</p>
                </div>
              </div>
            )}
          </div>
