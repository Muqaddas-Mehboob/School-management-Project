        ...
        {assignments.length === 0 ? (
          ...
          displayedAssignments.map(assignment => (
            <button
              ...
              className="w-full p-2 sm:p-3 md:p-4 border-b hover:bg-gray-300 transition-colors text-left"
              style={{
                borderColor: '#e5e7eb',
            ...
            >
              <div className="flex items-start justify-between mb-1 sm:mb-2">
                <h3 className="text-[10px] xs:text-xs sm:text-sm md:text-base font-semibold text-foreground pr-2 flex-1">
                  {assignment.title}
                </h3>
                <div 
              ...
              <div className="flex items-center gap-2 sm:gap-3 md:gap-4 text-[9px] xs:text-[10px] sm:text-xs text-muted-foreground">
      ...
      {hasMore && (
        <div className="border-t p-3 sm:p-4 bg-white" style={{ borderColor: '#e5e7eb' }}>
          <button
            ...
            className="w-full py-2 sm:py-2.5 rounded text-muted-foreground hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 text-[10px] xs:text-xs sm:text-sm"
